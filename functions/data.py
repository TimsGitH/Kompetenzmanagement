...
def load_profiles_with_ids(csv_path: str) -> list[str]:
    """
    Reads a CSV file containing profiles and returns a list of strings in the format "ID, Name".
    TODO: An google Sheet anpassen; unter config.py Pfad anpassen.

    Args:
        csv_path (str): Path to the CSV file (semicolon-separated)

    Returns:
        list[str]: A list like ["101, Fritz", "102, Peter", ...]
    """
    try:
