...
def page_3():
    ...
    st.number_input(label="Wie alt sind Sie? (1 eingeben falls Sie nicht antworten möchten)", min_value=1, max_value=99, key="answer_0SD06") # TODO: Möglichkeit nicht zu beantworten?
